                                    ...
                                    <td class="text-end">
                                        <div class="dropdown dropdown-action">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                <a id="{{ $department->id }}" class="dropdown-item edit" href="#"
                                                    data-toggle="modal" data-target="#edit"><i
                                                        class="fa fa-pencil m-r-5"></i>
                                                    Edit</a>
                                                <a id="{{ $department->id }}" class="dropdown-item delete" href="#"
                ...
                <div class="modal-body">
                    <form id="insert_form">
                        ...
                        <div class="form-group">
                            ...
                            <span class="text-danger error department_name_error"></span>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="edit_form">
                        ...
                        <div class="form-group">
                            <label>Department Name <span class="text-danger">*</span></label>
                            <input class="form-control" type="text" name="department_name" id="edit_department_name">
